...
class _UpdateCounterState extends State<UpdateCounter> {
  ...
  _loadCounter() async {
    ...
    setState(() {
      if(widget.counterNameFromUpdate != null && widget.counterNameFromUpdate != "")
        {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        SizedBox(
                          width:350.0,
                          child: Text(counterInfoName,
                            maxLines: 3,
                            overflow: TextOverflow.ellipsis,
                            softWrap: false,
                            style: TextStyle(color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 35.0,letterSpacing: 2.0,),
                          ),
                        ),
                      ],
                    ),
